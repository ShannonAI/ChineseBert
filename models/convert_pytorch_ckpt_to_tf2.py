...
from models.tf_modeling_glycebert import TFGlyceBertModel
...
CHINESE_BERT_PRETRAINED_CONFIG_ARCHIVE_MAP = {
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--tf_dump_path",
        default="/Users/github/ChineseBert/ChineseBERT-base/tf_model.h5"
        , type=str, help="Path to the output Tensorflow dump file."
    )
    parser.add_argument(
        "--model_type",
        default="chinese-bert",
        type=str,
    ...
    parser.add_argument(
        ...
        default="/Users/github/ChineseBert/ChineseBERT-base/pytorch_model.bin",
        type=str,
    ...
    parser.add_argument(
        "--config_file",
        default="/Users/github/ChineseBert/ChineseBERT-base/config.json",
        type=str,
    ...
    parser.add_argument(
        "--compare_with_pt_model", default=True, action="store_true", help="Compare Tensorflow and PyTorch model predictions."
    )
    parser.add_argument(
        "--use_cached_models",
        action="store_true",
